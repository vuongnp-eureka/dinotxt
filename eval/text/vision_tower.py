...
from ...layers import SelfAttentionBlock, SwiGLUFFN
from ...models.vision_transformer import init_weights_vit
...
def build_vision_model(
    ...
    if backbone is None:
        if backbone_model_config is not None:
            ...
            from ...models import build_model_from_cfg as build_vision_backbone
